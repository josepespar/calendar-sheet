...
const CHARACTERS = {
  ...
  joan:     { name: 'Joan (researcher)',      color: '#60A5FA', initials: 'J', shape: 'circle' },
...
const scenes = {
  ...
  scene_06: {
    ...
    personatge: 'joan',
    narracio: 'Joan takes the floor from an academic standpoint. He opens with a definition but immediately qualifies it from his ecological perspective.',
    dialeg: {
      personatge: 'joan',
  ...
  scene_09: {
    ...
    personatge: 'joan',
    punts: 10,
    narracio: 'Pau underlines Joan\'s contribution. He tries to rephrase it to make sure he has understood it correctly.',
    pregunta: 'Joan argues that, from the ecological perspective, motor control...',
    opcions: [
      {
        id: 'A',
  ...
  scene_11: {
    ...
    personatge: 'joan',
    narracio: 'Raquel poses the second major question of the round table. Joan takes the floor without waiting to be asked.',
    dialeg: {
      personatge: 'raquel',
  ...
  scene_12: {
    ...
    personatge: 'joan',
    narracio: 'Joan is clear and direct in his stance. The answer, for him, is unambiguous.',
    dialeg: {
      personatge: 'joan',
  ...
  scene_13: {
    ...
    personatge: 'joan',
    punts: 10,
    narracio: 'Pau stops writing and reflects on Joan\'s stance. He is clear on what was said, but wants to verify he has understood it correctly.',
    pregunta: 'What role does Joan attribute to biology in the development of motor control?',
    opcions: [
      {
        id: 'A',
        text: 'It is a necessary precondition, but prior experiences and learning are the truly determining factors',
        correcta: true,
        feedback: 'Perfect. Joan is explicit: biology is a **precondition** (it sets the initial limits), but it is not the determinant of motor development. What truly defines the level of motor control is lived experience and, above all, whether that experience has generated **real learning**: new ways of interacting with space, time, and others.'
      },
      {
        id: 'B',
        text: 'It completely determines the level of motor control an athlete can achieve',
        correcta: false,
        feedback: 'This would be the maturational or biological determinist position (Gesell, 1929). Joan distances himself from it: biology is a **precondition**, not a final determinant. If it were determinant, training and experience would make no sense — and we know they do.'
      },
      {
        id: 'C',
        text: 'Biology and experience carry exactly the same weight in motor development',
        correcta: false,
        feedback: 'Joan does not establish an equal balance. He states that biology is **subordinate** to experience: it is a precondition (a necessary base), but it is experience and learning that truly shapes motor control. The weight is not equal: experience prevails.'
      }
    ],
    seguent: 'scene_14'
  },
  ...
  scene_14: {
    ...
    personatge: 'esther',
    narracio: 'Esther adds to Joan and Andrés\'s contributions with a reflection grounded in her experience as an elite endurance runner.',
    dialeg: {
      personatge: 'esther',
    ...
    opcions: [
      {
        ...
        correcta: true,
        feedback: 'Exactly. Esther opens a new dimension: motor control work **is not solely associated with direct performance**. When motor control work allows the correction of injury-causing technical patterns, it contributes indirectly to **injury prevention**. Joan adds: "This confirms that motor control is perception." If feeling secure is the outcome, it means perception of one\'s own movement has improved.'
      },
      {
        id: 'B',
      ...
      },
      {
        ...
        correcta: false,
        feedback: 'Memorizing sequences is a **cognitivist** mechanism (motor program). Esther, on the contrary, talks about **body awareness**, sensation, security. She learns to sense her body, not to execute a memorized sequence. Joan himself questions whether what is learned consciously transfers to the unconscious behavior of competition.'
      }
    ],
    seguent: 'scene_18'
  },
  ...
  scene_18: {
    ...
    tipus: 'text_block',
    titol: 'Joan\'s Challenge: Is It Really Learned?',
    personatge: 'joan',
    narracio: 'Joan intervenes with a question that generates a great silence in the room. Pau stops taking notes.',
    dialeg: {
      personatge: 'joan',
  ...
  scene_19: {
    ...
    tipus: 'quiz',
    titol: 'Joan\'s Challenge on Awareness',
    personatge: 'joan',
    punts: 10,
    narracio: 'Esther nods. And Andrés reinforces Joan\'s idea from his experience with athletes in competition.',
    pregunta: 'Joan questions whether motor control is really learned. His central argument is...',
    opcions: [
      {
        id: 'A',
        ...
        correcta: true,
        feedback: 'Exactly. Joan identifies a **fundamental paradox**: if the change depends on conscious focus to be maintained, perhaps it was not real learning but a temporary change. Deep motor learning manifests in competition **without the need for conscious focus**. When the focus disappears and the change does too, we must ask whether there was real learning or merely superficial adaptation.'
      },
      {
        id: 'B',
        text: 'That the athlete cannot objectively measure their progress in motor control',
        correcta: false,
        feedback: 'Measurement is a different topic (which they will address in the next scene). Joan\'s doubt is about the **nature of learning**: whether what was learned is real or an illusion of learning generated by temporary conscious awareness of movement. It is not a measurement problem, it is a transfer problem.'
      },
      {
        id: 'C',
        text: 'That biology limits the capacity to learn new motor patterns in adult athletes',
        correcta: false,
        feedback: 'Joan had already made clear that biology is a precondition, not a definitive limit. His doubt is about **awareness and transfer**: does what is learned consciously (internal focus) transfer to the unconscious behavior of competition? This is the question that science, Joan says, has not definitively answered.'
      }
    ],
    seguent: 'scene_20'
  },
  ...
  scene_20: {
    ...
    personatge: 'andres',
    narracio: 'Andrés reflects on what Joan said and adds his own experience as a coach. The debate about awareness leads him to talk about the role of feedback and testing.',
    dialeg: {
      personatge: 'andres',
